import java.util.ArrayList;
 ...
 class MediaService {
     private ArrayList<MediaFunctions> mediaList;

     public MediaService() {
         mediaList = new ArrayList<>();
     }

     public void addMedia(MediaFunctions media) {
         mediaList.add(media);
     }
     ...
     public MediaFunctions findMediaByIndex(int index) {
         try {
     ...
     public ArrayList<MediaFunctions> getAllMedia() {
